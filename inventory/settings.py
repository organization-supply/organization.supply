...
STATIC_URL = '/static/'
STATIC_ROOT = config('DJANGO_STATIC_ROOT', default=os.path.join(os.path.dirname(BASE_DIR), 'static'))
MEDIA_URL = '/media/'
MEDIA_ROOT = config('DJANGO_MEDIA_ROOT', default=os.path.join(os.path.dirname(BASE_DIR), 'media'))
